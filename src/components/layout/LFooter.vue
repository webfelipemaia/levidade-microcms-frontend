      ...
      <div class="row">
          ...
          <div class="row" id="footer-links">
            <div class="col-lg-3 col-12">
              <div class="position-relative">
                ...
                <div class="d-lg-block collapse show" id="collapseLanding" data-bs-parent="#footer-links" style="">
                  <ul class="list-unstyled mb-0 py-3 py-lg-0">
                    <li class="mb-2">
                      <a href="#" class="text-decoration-none text-reset">Item 1</a>
                    </li>
                    <li class="mb-2">
                      <a href="#!" class="text-decoration-none text-reset">Item 2</a>
                    </li>
                    <li class="mb-2">
                      <a href="#!" class="text-decoration-none text-reset">Item 3</a>
                    </li>
                    <li class="mb-2">
                      <a href="#!" class="text-decoration-none text-reset">Item 4</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-12">
              <div>
                ...
                <div class="collapse d-lg-block" id="collapseAccounts" data-bs-parent="#footer-links">
                  <ul class="list-unstyled mb-0 py-3 py-lg-0">
                    <li class="mb-2">
                      <a href="#" class="text-decoration-none text-reset">Item 1</a>
                    </li>
            ...
            <div class="col-lg-3 col-12">
              ...
              <div class="collapse d-lg-block" id="collapseResources" data-bs-parent="#footer-links">
                <ul class="list-unstyled mb-0 py-3 py-lg-0">
                  <li class="mb-2">
                      <a href="#" class="text-decoration-none text-reset">Item 1</a>
                    </li>
            ...
            <div class="col-lg-3 col-12">
              ...
              <div class="collapse d-lg-block" id="collapseLocations" data-bs-parent="#footer-links">
                <ul class="list-unstyled mb-0 py-3 py-lg-0">
                  <li class="mb-2">
                      <a href="#" class="text-decoration-none text-reset">Item 1</a>
                    </li>
        ...
        <div class="col-lg-3 col-12">
          <div class="me-7">
            ...
            <p class="text-body-secondary">Levidade, 99, Lorem ipsum dolor<br>
              CEP: 24000-000<br>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-9 col-lg-6">
          <div class="small mb-3 mb-lg-0 text-lg-center">
            ...
            | Designed by
            <span class="text-primary"><a href="#">Levidade Web</a></span>
          </div>
        </div>
        <div class="col-lg-3">
